# Sprint 1 – Initial Task Allocation (Five-Member Team)

In accordance with the module requirement that the project be undertaken in a five-member team, Sprint 1 responsibilities have been allocated to enable parallel development while maintaining shared accountability and structured integration checkpoints.
...
- Implementation of **Semester Profile Creation (US1)**  
- Co-implementation of **Module Data Import and Validation (US2, US3)**  
- Final integration and preparation of the working increment  
...
- Validation of task input rules  
- Support for displaying tasks within module views  
...
- Linking activities to one or more tasks (US9)  
- Validation of activity input and edge cases  
...
- Ensuring consistency between activity data and task completion states  
...
Although responsibilities are divided for efficiency, Sprint 1 is delivered collectively:

- All members participate in design validation sessions  
- Code reviews are conducted before integration  
- Integration checkpoints occur mid-sprint to reduce late-stage conflicts  
- Testing is treated as a shared responsibility rather than isolated ownership  

This structure reflects agile principles and demonstrates effective parallel task management within a five-member team.
